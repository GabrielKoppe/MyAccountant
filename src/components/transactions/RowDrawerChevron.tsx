...
// 28x28 / ícone 16px — mesmo tamanho do cluster de ações da linha (favorito/
// pendente/⋮ em TransactionRowActions), para o chevron ficar realmente colado
// no ⋮ com gap 2px (spec 66 · Fidelidade, item 4/1). Sem `mr` embutido: o
// espaçamento do cluster é responsabilidade de quem posiciona o chevron
// (TransactionRowActions), não deste componente.
