...
export const WIDGET_REGISTRY: Record<DashboardContext, WidgetDef[]> = {
  monthly: [
    ...
    { id: "daily-heatmap",        labelKey: "dailyHeatmap",     kind: "panel", span: "half", defaultVisible: true },
    { id: "category-treemap",     labelKey: "categoryTreemap",  kind: "panel", span: "half", defaultVisible: true },
    { id: "money-flow",           labelKey: "moneyFlow",        kind: "panel", span: "full", defaultVisible: true },
    { id: "section-breakdown",    labelKey: "sectionBreakdown", kind: "panel", span: "half", defaultVisible: true },
  ...
  yearly: [
    ...
    { id: "kpi-pending",          labelKey: "pending",          kind: "kpi",   defaultVisible: true },
    { id: "month-card-grid",      labelKey: "monthCardGrid",    kind: "panel", span: "full", defaultVisible: true },
    { id: "monthly-bar-chart",    labelKey: "monthlyBarChart",  kind: "panel", span: "full", defaultVisible: true },
    { id: "pinned-analyses",      labelKey: "pinnedAnalyses",   kind: "panel", span: "full", defaultVisible: true },
    { id: "top-categories",       labelKey: "topCategories",    kind: "panel", span: "full", defaultVisible: true },
  ],
  month_summary: [
    { id: "kpi-income",           labelKey: "income",           kind: "kpi",   defaultVisible: true },
    { id: "kpi-expenses",         labelKey: "expenses",         kind: "kpi",   defaultVisible: true },
